...
public class myTests implements Runnable{
    ...
    public void getDriver(PlatformType platform, String version, String OS, String testName, boolean generateReport) throws Exception{
        //Set Browser Type
        ...
        System.out.println("1SAF"+Thread.currentThread().toString());

       	this.driver = new RemoteWebDriver(url, dc);
       	
       	System.out.println("2SAF"+Thread.currentThread().toString());
